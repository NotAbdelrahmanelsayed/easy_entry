frappe.query_reports["Items Missing Prices"] = {
    ...
    formatter: function (value, row, column, data, default_formatter) {
        ...
        if ((column.fieldname === "buying_price"  && !data.has_buying) ||
    ...
    onload: function (report) {
        report.page.wrapper.on("click", ".ee-fill-valuation", function (e) {
            ...
            frappe.call({
                ...
                callback: function () {
                    frappe.show_alert({ message: __("Price added for {0}", [item_code]), indicator: "green" });
                    report.refresh();
                },
            });
        });
        ...
        report.page.wrapper.on("click", ".ee-add-price", function (e) {
            ...
            let label      = price_list === "Standard Buying" ? __("Buying Price") : __("Selling Price");
